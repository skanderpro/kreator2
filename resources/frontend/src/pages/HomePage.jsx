  ...
  return (
    <>
      <div className="head-banner">
        <img src={headBanner} alt="House" className="head-banner__img" />
        <div className="container">
          <div className="head-banner__inner">
            <div className="head-banner_inner">
              <h1 className="head-banner__title">Набережна Вежа</h1>
              <p className="head-banner__subtitle">Ваш простір спокою</p>
          ...
          <div className="gallery">
            <div className="gallery-text">
              ...
              <p>
                ...
                перевагою якого є місце розташування.
              </p>
            </div>
            <div className="gallery-swiper">
              ...
              >
                {newsSwiperList.map((items, index) => {
                  return (
                    <SwiperSlide className="gallery-swiper-item" key={index}>
                      <img
        ...
        <div className="advantages">
          <div className="advantages-header">
            ...
            <p>
              ...
              проглядається одна з найкрасивіших панорам Тернополя. Поруч
              комплексу розташований Парк Шевченка.
            </p>
          </div>
        ...
        <div className="construction">
          ...
          <div className="construction-timeline">
            <div className="construction-timeline-line">
              ...
              <div className="timeline" style={{ width: "80%" }}></div>
              ...
              >
                ...
                <circle cx="19.5" cy="19.5" r="4.5" fill="#311B00" />
              </svg>
            </div>
          ...
          <div className="construction-swiper">
            ...
            >
              {constructionSwiperList.map((items, index) => {
                return (
                  <SwiperSlide className="construction-swiper-item" key={index}>
        ...
        <div className="about-us" id="about">
          ...
          <div className="about-us-info">
            ...
            <p className="about-us-info-text">
              ЖК «Набережна Вежа» – це комплекс бізнес класу, головною перевагою
              якого є місце розташування. Комплекс зводиться в екологічно
              чистому районі, поруч Тернопільського ставу.
            </p>
            <p>
              Унікальність ЖК «Набережна Вежа» у тому, що з його вікон
              проглядається одна з найкрасивіших панорам Тернополя. 80 відсотків
              квартир матимуть розкішний вигляд на Тернопільську набережну.
              Поруч комплексу розташований Парк Шевченка, тому ранкові пробіжки
              біля озера чи вечірні прогулянки велосипедами з сім’єю парковою
              оазою – це мрія, яка стане реальністю для кожного мешканця
              комплексу.
            </p>
            <p>
              Комплекс віддалений від шумних магістралей, тут спокій, свіже
              повітря, можливість відпочинку у найкрасивішому місці обласного
              центру, де щовечора своєю красою вражають розмаїті фонтани і
              вражаючі колоритністю сквери.
            </p>
            <a href="#" className="btn">
              ЗАПИСАТИСЬ НА ОГЛЯД
            </a>
        ...
        <div className="news">
          ...
          <div className="news-swiper">
            ...
            >
              {newsSwiperList.map((items, index) => {
                return (
                  <SwiperSlide className="news-swiper-item" key={index}>
                    <NavLink to="news" />
                    <img
        ...
        <div className="container">
          <div className="documents">
            ...
            <div className="documents-items">
              ...
              <div className="documents-item">
                <p>
                  Ліцензія на ведення господарської діяльності з будівництва
            ...
            <div className="contact-info">
              ...
              <div className="contact-info-list">
                <div className="contact-info-list-item">
                  ...
                  <ul>
                    <li> Центральний відділ продажу – вул. Листопадова, 1/3</li>
                    <li>
                      <a href="tel:381708742">+38(067)-170-87-42</a>
                    </li>
                    <li>
