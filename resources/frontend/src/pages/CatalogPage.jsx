            ...
            <div className="catalog-header">
              ...
              <div className="catalog-header-sort">
                ...
                <select name="" id="" className="filter-select">
                  ...
                  <option value="">Від малих до великих</option>
                  <option value="">Від великих до малих</option>
                </select>
              </div>
            </div>
            ...
            <div className="catalog-main">
              ...
              >
                ...
                <div className="card-apartments-filter-item">
                  ...
                  <div className="card-apartments-filter-inner">
                    <div className="list-tab">
                      <div className="list-tab-item">Так</div>
                      <div className="list-tab-item">Ні</div>
                    </div>
                  </div>
                </div>
                <div className="card-apartments-filter-item">
                  ...
                  <div className="card-apartments-filter-inner">
                    <div className="list-tab">
                      <div className="list-tab-item">Акція</div>
                      <div className="list-tab-item">Кредит</div>
                      <div className="list-tab-item">Розстрочка</div>
                    </div>
                  </div>
                </div>
                <button className="btn btn-primary">ОЧИСТИТИ</button>
                      ...
                      >
                        ...
                        <div className="catalog-list-item-info">
                          <div className="catalog-list-item-info-item">
                            {item.area} <span>м.кв</span>
                          </div>
                          <div className="catalog-list-item-info-item">
                            {item.room} <span>кімната</span>
                          </div>
                          <div className="catalog-list-item-info-item">
                            {item.floor} <span>поверх</span>
                          </div>
                        </div>
                        <div className="catalog-list-item-price">
                          {item.priceArea} <span>грн/м.кв</span>
                        </div>
