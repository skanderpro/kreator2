                ...
                <div className="container">
                    <div className="questions__inner">
                        <div className="questions-header">
                            ...
                            <p>
                                Наші менеджери зв’яжуться з вами найближчим
                                часом та допоможуть розрахувати вартість
                                нерухомості в залежності від обраного вами
                                способу придбання, та розмір першого внеску та
